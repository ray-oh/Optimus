...
Echo zipping...
"C:\Program Files\7-Zip\7z.exe" a -tzip ".\optimus_package_%today%_mini.zip" ".\tmp\*" -mx0 -xr!install -x!tmp -x!src -xr!venv -xr!__pycache__ -xr!pyc -xr!bak -xr!old -xr!temp -xr0!optimus_package*.zip -xr0!optimus_package*.bat
rmdir tmp /S /Q
echo Done!
Pause
exit /b
